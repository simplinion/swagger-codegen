        ...
        for (CodegenOperation op : operationList) {
            ...
            for (CodegenParameter param : op.allParams) {
                ...
                if (param.isContainer) {
                    ...
                    param.vendorExtensions.put("x-containerType", true );
                }
                else{
                    param.vendorExtensions.put("x-containerType", false );
                }
    ...
    public Map<String, Object> postProcessModels(Map<String, Object> objs) {
        ...
        for (CodegenProperty var : model.vars) {
            if (var.datatype != null) {
                ...
                if (var.isContainer) {
                    var.vendorExtensions.put("x-commentType", var.datatype+"[]");
                    var.vendorExtensions.put("x-containerType", true);
                }
                else{
                    var.vendorExtensions.put("x-containerType", false);
                }
